...
if (isset ($_POST["username"]) && isset ($_POST["password"])) {
	...
	if ($user != false) {
		if ($user["encrypted_password"] == hash("sha256", $_POST["password"])){
			session_start();
	...
	<div id="everything" class="container">
		<main class="form-signin">
			...
			<form id="loginForm" method="POST">
				<img class="mb-4" src="./imgs/logo.png" alt="" width="300" height="70"
					style="display: block;margin-left: auto;margin-right: auto;border-radius:4px;border:solid black 1px;">
...
<script>
	...
	if (isset($_POST["password"])) {
  		echo 'document.getElementById("password").value = "'.$_POST["password"].'";';
	}
	?>
	// function login() {
