        ...
        function updateChatUI(messages, userId) {
            ...
            messages.forEach(function(message) {
                ...
                if (message.user_id == userId) {
                    ...
                    var deleteBtnSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="#ff0000">
                    <path d="M0 0h24v24H0z" fill="none"/>
                    <path d="M0 0h24v24H0V0z" fill="none"/>
                    <path d="M9 16h6c.55 0 1-.45 1-1s-.45-1-1-1H9c-.55 0-1 .45-1 1s.45 1 1 1zM19 4h-3.17L15 2H9L7.17 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H5V8h14v10z"/>
                    </svg>`;

                    var deleteBtn = document.createElement("button");
                    deleteBtn.innerHTML = deleteBtnSVG;
                    deleteBtn.classList.add("delete-button");
                    deleteBtn.onclick = function() { deleteMessage(message.message_id); }; // Corrected message_id reference here
                    messageDiv.appendChild(deleteBtn);
