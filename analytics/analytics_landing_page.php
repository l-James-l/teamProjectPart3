        ...
        <div class="main-content-container">
            ...
            <div class="row" style="margin: auto;">
                ...
                <div class="dropdown col-2" style="padding: 0px">
                    ...
                    <div class="dropdown-menu" aria-labelledby="filterDropdownMenuButton">
                        <button class="dropdown-item d-flex justify-content-between" type="button"
                            onclick="change_sort_value('task_count');get_user_json()">On Going Tasks<i id="task_countToggleIcon" class="sortOption bi"></i></button>
                        <button class="dropdown-item d-flex justify-content-between" type="button"
                            onclick="change_sort_value('first_name');get_user_json()">First Name<i id="first_nameToggleIcon" class="sortOption bi"></i></button>
                        <button class="dropdown-item d-flex justify-content-between" type="button"
                            onclick="change_sort_value('surname');get_user_json()">Surname<i id="surnameToggleIcon" class="sortOption bi bi-check"></i></button>
